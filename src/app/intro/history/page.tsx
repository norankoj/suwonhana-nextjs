...
export default async function HistoryPage() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-accent-700 via-cyan-600 to-teal-500 selection:bg-white selection:text-accent-900">
      ...
      <section className="relative z-10 max-w-content mx-auto px-4 sm:px-6 lg:px-8 pt-44 md:pt-56 lg:pt-64 pb-20 md:pb-24 lg:pb-32 flex flex-col lg:flex-row gap-16 lg:gap-24">
        {/* [좌측] 타이틀 영역 */}
        <div className="lg:w-1/3 lg:sticky lg:top-32 h-fit relative z-10">
          ...
          <h2 className="text-4xl/[1.4] md:text-5xl/[1.4] lg:text-6xl/[1.4] font-extrabold text-white mb-10 tracking-wide">
            하나님이
            <br />
            인도하신 길
          </h2>
                    ...
                    <div className="flex-1 space-y-6 mt-1 sm:mt-1.5">
                      {item.events.map((event: HistoryEvent, eIdx: number) => {
                        ...
                        return (
                          <div
                            key={eIdx}
                            className="text-white text-[15px] md:text-[18px] leading-[1.8] break-keep"
                          >
                            {formattedDate && (
