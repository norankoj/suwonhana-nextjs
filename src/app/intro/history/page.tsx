...
export default async function HistoryPage() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-blue-700 via-cyan-600 to-teal-500 selection:bg-white selection:text-blue-900">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-44 md:pt-56 lg:pt-64 pb-20 md:pb-24 lg:pb-32 flex flex-col lg:flex-row gap-16 lg:gap-24">
        {/* [좌측] 타이틀 영역 */}
